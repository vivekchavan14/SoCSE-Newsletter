...
const Newsletter = ({ title, image, price }) => {
  return (
    <div className ="border border-gray-300 rounded-lg p-5 text-center w-72 bg-white shadow-md transition-transform duration-300 ease-in-out mb-5 hover:transform hover:-translate-y-5">
      ...
      <button className="bg-blue-500 text-white rounded-md px-4 py-2 mt-4 cursor-pointer transition duration-300 ease-in-out hover:bg-blue-700" onClick={()=>{ alert("View article")}}>View article</button>
    </div>
  );
};
